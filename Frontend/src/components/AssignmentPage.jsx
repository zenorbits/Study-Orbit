  ...
  return (
    <div className="min-h-[80vh] w-full font-mono p-10
      ...
      <input
        ...
        className="w-full md:w-1/2 p-2 mb-6 rounded-md border border-gray-300 dark:border-gray-600
      ...
      {filteredAssignments.map((a) => {
        const batchName = verifiedBatches.find(b => b._id === a.batch)?.batchname || "Unknown Batch";
        return (
